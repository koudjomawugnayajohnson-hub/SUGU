...
import { Search, Receipt, Trash2, Trash, ArrowLeft, Loader2 } from 'lucide-react'
...
export default function PosPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // 4. Succès : Nettoyage et notification
      setCart([])
      if (typeof window !== 'undefined') {
        localStorage.removeItem('sugu_offline_cart')
      }
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gray-50 overflow-hidden font-sans">
      ...
      <div className="flex flex-col w-full lg:w-[30%] h-[50vh] lg:h-full bg-white relative shadow-[-4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        {/* Liste des articles (Défilement interne) */}
        ...
        {/* Résumé financier & Bouton Encaissement (Fixé en bas) */}
